...
abstract class AppLocalizations {
  ...
  /// No description provided for @footerByContinuing.
  ///
  /// In en, this message translates to:
  /// **'By continuing, you agree to TradeQuest\'s '**
  String get footerByContinuing;
  ...
  /// No description provided for @footerAnd.
  ///
  /// In en, this message translates to:
  /// **' and '**
  String get footerAnd;
  ...
  /// No description provided for @alreadyAgent.
  ///
  /// In en, this message translates to:
  /// **'Already an agent? Log in'**
  String get alreadyAgent;
